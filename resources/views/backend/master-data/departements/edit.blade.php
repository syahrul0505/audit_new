        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">/</li>
                    <li class="breadcrumb-item active"><a href="{{ route('backend.departements.index') }}">Departements</a></li>
                </ol>
            </div>
...
<div class="row mt-4 mb-4">
    <div class="col-sm-8">
        <div class="card card-primary">
            ...
            <form method="POST" action="{{ route('backend.departements.update', $departement->id) }}" novalidate>
                @method('patch')
                @csrf
                ...
                <div class="card-footer bg-gray1" style="border-radius:0px 0px 10px 10px;">
                    ...
                    <a href="{{ route('backend.departements.index') }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
