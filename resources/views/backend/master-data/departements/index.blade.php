                ...
                <div class="card-header" style="background-color: #2a3042dc !important; border-radius:10px 10px 0px 0px;">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 d-flex justify-content-end">
                            <a href="{{ route('backend.departements.create') }}" class="btn btn-md btn-info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('backend.departements.edit', $departement->id) }}"
                                            ...
                                            <a href="#" class="btn btn-danger f-12" onclick="modalDelete('Departement', '{{ $departement->name }}', '/yakesma/admin/master-data/departements/' + {{ $departement->id }}, '/yakesma/admin/master-data/departements/')">
