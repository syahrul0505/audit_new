...
<div class="row ">
    ...
    <div class="col-lg-3 col-md-6" id="product" onclick="location.href='{{ route('backend.warehouse.index')}}'">
        <div class="box card">
            <div class="box-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column tx-xs-medium">
                        <span class="text-dark font-weight-bold" style="font-size: 16.5px;">Warehouse</span>
                    </div>
                </div>
            </div>
        </div>
